...
class LoginController extends ChangeNotifier {
  ...
  Future<Map<String, dynamic>?> _panggilAPINominatim(double lat, double lon) async {
    try {
  ...
  Future<bool> cekAksesKurir(double lat, double lon) async {
    try {
      ...
      if (responsAPI['address'] != null && responsAPI['address']['county'] != null) {
      ...
      if (!aksesDisetujui) {
        _errorMessage = 'Akses ditolak. Anda berada di wilayah $namaKabupatenKurir. '
  ...
  Future<void> login(BuildContext context) async {
    ...
    try {
      ...
      bool aksesDisetujui = await cekAksesKurir(position.latitude, position.longitude);
